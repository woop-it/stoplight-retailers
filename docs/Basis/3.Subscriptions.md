...
| trackingPageRrl  | [/orders/{orderId}/trackingPageUrl](https://woop.stoplight.io/docs/retailer/woop_to_retailer.json/paths/~1orders~1%7BorderId%7D~1trackingPageUrl/put)            |
